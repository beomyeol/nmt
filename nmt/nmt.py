...
def add_arguments(parser):
  ...
  parser.add_argument("--profile_dir", default="",
                      help="Store profile results.")
  parser.add_argument("--steps_per_profile", type=int, default=100,
                      help="How many training steps to do per profiling.")
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      steps_per_profile=flags.steps_per_profile,
